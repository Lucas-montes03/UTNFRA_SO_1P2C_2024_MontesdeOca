...
sudo useradd -m -s /bin/bash -c "Primer alumno" -p $password -G p1c2_2024_gAlumno p1c2_2024_A1

sudo useradd -m -s /bin/bash -c "Segundo alumno" -p $password -G p1c2_2024_gAlumno p1c2_2024_A2

sudo useradd -m -s /bin/bash -c "Tercer alumno" -p $password -G p1c2_2024_gAlumno p1c2_2024_A3

sudo useradd -m -s /bin/bash -c "Primer profesor" -p $password -G p1c2_2024_gProfesores p1c2_2024_P1
...
sudo su vagrant
sudo chmod 777 /Examenes-UTN/alumno_{1,2,3} /Examenes-UTN/profesores

#Creamos el archivo 'validar.txt'
...
echo "Permisos otorgados en los directorios"
